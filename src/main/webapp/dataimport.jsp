...
<body>
	...
	<form class="form-horizontal well" action="dataImport!dataImport"
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<label class="radio-inline"> <input type="radio" onclick="setSHDateShowOrHide()"
					name="importType" id="importType" value="SH" <s:if test="importType=='SH'"> checked</s:if>> 发货数据
				</label> <label class="radio-inline"> <input type="radio" onclick="setSHDateShowOrHide()"
...
<!-- 			    <label class="radio-inline"> <input type="radio" onclick="setSHDateShowOrHide()" -->
<!-- 					name="importType" id="importType" value="IV" <s:if test="importType=='IV'"> checked</s:if>> -->
<!-- 					进销存数据 -->
<!-- 				</label>				 -->
				<div class="" id="div_sh_show" style="display: none;">
					...
					<select type="select" name="fscMon" id="fscMon">
