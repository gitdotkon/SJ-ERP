...
<script type="text/javascript" src="${ctx }/js/workorders.js"></script>
	...
	<h4>
		...
		<div class="form-inline" role="form">
				...
				<div class="input-group" style="width:200px">
					<div class="input-group" style="width:200px">
						<span class="input-group-addon">姓名：</span> <input type="text"
							class="form-control" id="workerName" name="workerName"
			...
			<div class="form-group">
				<div class="input-group" style="width:200px">
					<div class="input-group" style="width:200px">
						<span class="input-group-addon">零件图号：</span> <input type="text"
							class="form-control" id="partCode" name="partCode"
							style="width:100px"> <span class="input-group-btn">
						</span>
					</div>
				</div>
				...
				<div class="input-group" style="width:200px">
					<span class="input-group-addon">排产时间：</span> <input type="text"
						...
						<button type="button" class="btn btn-default"
							onClick="addWorkOrder();">添加流水</button>
					</span>
				</div>
			</div>
