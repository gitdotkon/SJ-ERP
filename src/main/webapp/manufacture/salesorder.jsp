		...
		<form action="" name="data_form" id="data_form" class="form-inline"
			...
			<div class="form-group">
				...
				<div class="input-group" style="width:400px">
					<span class="input-group-addon">要求发货时间：</span> <input type="text"
						class="form-control" id="deliveryDate" name="deliveryDate"
						style="width:100px"> <span class="input-group-btn">
					</span>
					
					<span class="input-group-addon">要求完成时间：</span> <input type="text"
