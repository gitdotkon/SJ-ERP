...
<script type='text/javascript'
	src="manufacture/js/manufacture.js"></script>
<script type='text/javascript'
...
<body>
<h4>仓库管理. <small>入库</small></h1> 
	

		
			<div class="form-inline" role="form">
				<div class="form-group">
					<label class="sr-only">零件类型</label>
				...
				<div class="form-group" >
					<div class="input-group" style="width:200px">
						<input type="text"  class="form-control" placeholder="零件图号"  id="partCode" name="partCode" value="${partCode}"  onKeyPress="onCheckEnter(event)">
					   <span class="input-group-btn">
						  <button class="btn btn-default" type="button" onClick="onStockSearch()">
							 查询
						  </button>
					   </span>
					</div>
			...
			<div id="partPager"></div>
				...
				<div class="form-group">
					...
					<div class="input-group"  style="width:200px">
					 ...
					 <input type="text"  class="form-control" id="warehousingDate" name="warehousingDate"  style="width:100px" >
					 <span class="input-group-btn">
